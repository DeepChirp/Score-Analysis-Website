...
cur.execute("DROP INDEX IF EXISTS idx_student_id ON scores")
cur.execute("DROP INDEX IF EXISTS idx_exam_id ON scores")
cur.execute("DROP INDEX IF EXISTS idx_class ON students")
cur.execute("DROP INDEX IF EXISTS idx_student_id_exam_id ON scores")
cur.execute("DROP INDEX IF EXISTS idx_subject_id ON scores")
cur.execute("DROP INDEX IF EXISTS idx_exam_id_subject_id ON scores")
cur.execute("DROP INDEX IF EXISTS idx_value ON scores")
...
cur.execute("CREATE INDEX idx_exam_id ON scores (exam_id)")
cur.execute("CREATE INDEX idx_class ON students (class)")
cur.execute("CREATE INDEX idx_student_id_exam_id ON scores (student_id, exam_id)")
cur.execute("CREATE INDEX idx_subject_id ON scores (subject_id)")
cur.execute("CREATE INDEX idx_exam_id_subject_id ON scores (exam_id, subject_id)")
cur.execute("CREATE INDEX idx_value ON scores (value)")
conn.commit()
